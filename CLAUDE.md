...
| `/review-doc` | 문서 검토 | `/review-doc docs/promql-guide.md` |
...
| 문서 | 주제 |
|------|------|
| `docs/install.md` | kube-prometheus-stack 설치 (Helm) |
...
| `docs/alerting-guide.md` | 알림 규칙 및 Alertmanager |
| `docs/service-monitor-guide.md` | ServiceMonitor/PodMonitor |
| `docs/exporters-guide.md` | Exporter 종류 및 활용 |
| `docs/storage-guide.md` | TSDB 스토리지 관리 |
| `docs/remote-write-guide.md` | Remote Write 설정 |
